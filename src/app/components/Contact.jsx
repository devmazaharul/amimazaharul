  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (
        ...
        let writeMsg = `<div  style="font-family: monospace;text-transform: capitalize;line-height: 13px;>
                <p>mailer : ${contactstate.name}</p>
                 <p>mailer email :${contactstate.email}</p>
      <div >
        <p>Message,</p>
        <p style="line-height: 20px">${contactstate.message}</p>
