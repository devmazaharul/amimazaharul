    ...
    <div className='py-16 px-4 bg-white rounded-xl  mb-4 '>
     ...
     <p className='flex items-center gap-1 border rounded-full w-fit px-2 py-1 text-sm text-gray-500 mb-6 '>INTRODUCE <IoHomeOutline className='text-[#00bc91]'/></p>
       ...
       <div className='md:grid md:grid-cols-3'>
        ...
        <h1 className=' font-bold text-3xl capitalize pb-2'>I Craft The </h1>
        ...
        <div className='flex w-fit items-center gap-2 text-gray-400 text-sm py-3'>
            <p className='flex gap-1 items-center'> <GiNetworkBars className='text-[#00bc91]'/> Available for work</p>
        ...
        <div className='my-4 text-center md:text-left'>
            {actionButton.map((item=>(
                <Link key={Math.random()} className={`bg-[${primary}] text-gray-100  px-7 py-2 rounded-full hover:bg-[${hover_bakground}]`} href={item.path}>{item.name}</Link>
            )))}
